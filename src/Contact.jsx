   ...
   return (
      <div className="w-full flex flex-col items-center mt-6 px-4 mb-12 font-one">
         ...
         >
            ...
            <button
               type="submit"
               className="w-full bg-blue-500 text-white py-3 rounded-lg hover:bg-blue-700 transition-all hover:cursor-pointer transition-transform transform hover:scale-105"
            >
               Send Message
            </button>
